...
28 rows across four sealed pillars, each admitted by a single offline oracle with four
...
| pillar | scope | rows |
|---|---|---|
| p1 | math & gradient integrity | 10 |
| p2 | systems & hardware | 7 |
| p3 | optimization topology | 5 |
| p4 | gotchas & anomalies | 6 |
